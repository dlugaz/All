...
.dlls,em4 .dlls: gpiointerrupt_cc3200_lp.pem4

-include package/cfg/gpiointerrupt_cc3200_lp_pem4.mak
-include package/cfg/gpiointerrupt_cc3200_lp_pem4.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/gpiointerrupt_cc3200_lp_pem4.dep
endif
gpiointerrupt_cc3200_lp.pem4: package/cfg/gpiointerrupt_cc3200_lp_pem4.xdl
	@


ifeq (,$(wildcard .libraries,em4))
gpiointerrupt_cc3200_lp.pem4 package/cfg/gpiointerrupt_cc3200_lp_pem4.c: .libraries,em4
endif

package/cfg/gpiointerrupt_cc3200_lp_pem4.c package/cfg/gpiointerrupt_cc3200_lp_pem4.h package/cfg/gpiointerrupt_cc3200_lp_pem4.xdl: override _PROG_NAME := gpiointerrupt_cc3200_lp.xem4
package/cfg/gpiointerrupt_cc3200_lp_pem4.c: package/cfg/gpiointerrupt_cc3200_lp_pem4.cfg
package/cfg/gpiointerrupt_cc3200_lp_pem4.xdc.inc: package/cfg/gpiointerrupt_cc3200_lp_pem4.xdl
package/cfg/gpiointerrupt_cc3200_lp_pem4.xdl package/cfg/gpiointerrupt_cc3200_lp_pem4.c: .interfaces

clean:: clean,em4
	-$(RM) package/cfg/gpiointerrupt_cc3200_lp_pem4.cfg
	-$(RM) package/cfg/gpiointerrupt_cc3200_lp_pem4.dep
	-$(RM) package/cfg/gpiointerrupt_cc3200_lp_pem4.c
	-$(RM) package/cfg/gpiointerrupt_cc3200_lp_pem4.xdc.inc

clean,em4::
	-$(RM) gpiointerrupt_cc3200_lp.pem4
.executables,em4 .executables: gpiointerrupt_cc3200_lp.xem4

gpiointerrupt_cc3200_lp.xem4: |gpiointerrupt_cc3200_lp.pem4

-include package/cfg/gpiointerrupt_cc3200_lp.xem4.mak
gpiointerrupt_cc3200_lp.xem4: package/cfg/gpiointerrupt_cc3200_lp_pem4.oem4 
	$(RM) $@
	@$(MSG) lnkem4 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/gpiointerrupt_cc3200_lp_pem4.oem4   package/cfg/gpiointerrupt_cc3200_lp_pem4.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4.rootDir)/lib/libc.a
	
gpiointerrupt_cc3200_lp.xem4: export C_DIR=
gpiointerrupt_cc3200_lp.xem4: PATH:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)
gpiointerrupt_cc3200_lp.xem4: Path:=$(ti.targets.arm.elf.M4.rootDir)/bin/;$(PATH)

gpiointerrupt_cc3200_lp.test test,em4 test: gpiointerrupt_cc3200_lp.xem4.test

gpiointerrupt_cc3200_lp.xem4.test:: gpiointerrupt_cc3200_lp.xem4
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 gpiointerrupt_cc3200_lp.xem4.test
else
	@$(MSG) running $<  ...
	$(call EXEC.gpiointerrupt_cc3200_lp.xem4, ) 
endif

clean,em4::
	-$(RM) $(wildcard .tmp,gpiointerrupt_cc3200_lp.xem4,*)


clean:: clean,em4

clean,em4::
	-$(RM) gpiointerrupt_cc3200_lp.xem4
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
gpiointerrupt_cc3200_lp_pem4.oem4,copy : package/cfg/gpiointerrupt_cc3200_lp_pem4.oem4
gpiointerrupt_cc3200_lp_pem4.sem4,copy : package/cfg/gpiointerrupt_cc3200_lp_pem4.sem4
